...
window.addEventListener('load', function () {
	...
	var productToyota = document.querySelectorAll(
		'.product-toyotaxe .product-xe'
	);
	...
	productLeft.addEventListener('click', () => {
		...
		document.querySelector('.product-toyotaxe').style.right =
			IndexProduct * 100 + '%';
	});
...
window.addEventListener('load', function () {
	...
	var productToyota2 = document.querySelectorAll(
		'.product2-toyotaxe .product-xe'
	);
	let IndexProduct2 = 0;
	...
	productLeft2.addEventListener('click', () => {
		...
		document.querySelector('.product2-toyotaxe').style.right =
			IndexProduct2 * 100 + '%';
	});
...
window.addEventListener('load', function () {
	...
	var productToyota3 = document.querySelectorAll(
		'.product3-toyotaxe .product-xe'
	);
	let IndexProduct3 = 0;
	...
	productLeft3.addEventListener('click', () => {
		...
		document.querySelector('.product3-toyotaxe').style.right =
			IndexProduct3 * 100 + '%';
	});
...
window.addEventListener('load', function () {
	...
	var productToyota4 = document.querySelectorAll(
		'.product4-toyotaxe .product-xe'
	);
	let IndexProduct4 = 0;
	...
	productLeft4.addEventListener('click', () => {
		...
		document.querySelector('.product4-toyotaxe').style.right =
			IndexProduct4 * 100 + '%';
	});
...
window.addEventListener('load', function () {
	...
	var productToyota5 = document.querySelectorAll(
		'.product5-toyotaxe .product-xe'
	);
	let IndexProduct5 = 0;
	...
	productLeft5.addEventListener('click', () => {
		...
		document.querySelector('.product5-toyotaxe').style.right =
			IndexProduct5 * 100 + '%';
	});
